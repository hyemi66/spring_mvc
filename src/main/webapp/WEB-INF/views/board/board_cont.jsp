		...
		<tr>
			<th colspan="2">
				...
				onclick="if(confirm('정말로 삭제할까요?') == true) {
					...
					<%-- 자바스크립트의 confirm()내장함수는 확인/취소 버튼을 가진 창을 만든다.
					확인을 클릭하면 true를 반환해서 삭제창, 취소시 false를 반환해서 현재창에 그대로 있게 한다
					이 기능은 다시 한번 더 삭제 유무를 묻게 하는 것이다. --%>
...
<%-- 댓글 수정화면 --%>
	...
	<script type="text/javascript">
		$bno = ${bc.bno}; // 게시판 bno 임시적으로 할당, $bno는 jQuery변수이고, ${bc.bno}는 표현언어인 EL이다
		// 즉, 자바스크립트에서 JSP문법인 EL 또는 JSTL 사용가능하다
